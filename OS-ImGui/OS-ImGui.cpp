...
namespace OSImGui
{
    ...
    void OSImGui::MyCheckBox2(const char* str_id, bool* v)
    {
        ...
        ImU32 Color;
        if (ImGui::IsItemHovered())
            Color = ImGui::GetColorU32(ImLerp(ImVec4(0.0f, 1.0f, 0.0f, 1.000f), ImVec4(0.08f, 0.18f, 0.21f, 1.0f), t));
        else
            
            Color = ImGui::GetColorU32(ImLerp(ImVec4(0.12f, 0.22f, 0.25f, 1.0f), ImVec4(0.0f, 1.0f, 0.0f, 1.000f), t));
        // 组件绘制
        ...
        if (*v)
            DrawList->AddText(ImVec2(p.x + 45, p.y + 2), ImColor{ 0,255,0,255 }, str_id);
        else
